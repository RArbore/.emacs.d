...
(defface powerline-modified-face '((t (:foreground "#F74C66" :background "#1C1F24" :inherit mode-line)))
  "Powerline modified face."
  :group 'powerline)

(defface powerline-saved-face '((t (:foreground "#98BE65" :background "#1C1F24" :inherit mode-line)))
  "Powerline saved face."
  :group 'powerline)

(defface powerline-readonly-face '((t (:foreground "#60b1f6" :background "#1C1F24" :inherit mode-line)))
  "Powerline readonly face."
  :group 'powerline)

;;;###autoload
(defun powerline-russel-evil-theme ()
  "Setup the default mode-line."
  (interactive)
  (setq-default
   mode-line-format
              ...
              (append
               ...
               (list (powerline-raw " " face3)
                     ...
                     (when (eq major-mode 'paradox-menu-mode)
                       (powerline-paradox face2 'l))
                     (powerline-raw " " face2)
                     (funcall separator-left 'powerline-modified-face face1)
                     (when (boundp 'erc-modified-channels-object)
                       (powerline-raw erc-modified-channels-object face1 'l))
                     (powerline-raw " " face1)
                     (powerline-raw
