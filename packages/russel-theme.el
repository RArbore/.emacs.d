...
(let ((my-active       "#FB4934")
       (my-visited      "#928374")
       (my-info         "#B8BB26")
       (my-highlight    "#FE8019")
       (my-contrast     "#665C54")
       (my-deepcontrast "#504945")
       (my-hicontrast   "#EBDBB2")
       (my-shadow       "#282828")
       (my-pop          "#83A598")
       (my-warning      "#FE8019")
       (my-btw          "#FB4934")
...
;;;; Theme Faces
  (custom-theme-set-faces
    ...
    `(font-lock-negation-char-face ((t (:foreground "#B8BB26"))))
    ...
    `(font-lock-string-face ((t (:foreground "#B8BB26" :slant italic :weight extra-light))))
    ...
    `(tooltip ((t (:foreground ,my-shadow :background "#D5C4A1")) (t (:inherit (variable-pitch)))))
